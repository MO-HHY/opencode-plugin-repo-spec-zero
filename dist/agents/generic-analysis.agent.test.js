...
describe('GenericAnalysisAgent', () => {
    ...
    beforeEach(() => {
        vi.resetAllMocks();
        agent = new GenericAnalysisAgent(mockConfig, mockRouter, mockTemplateLoader, mockDiagramGenerator);
    });
...
`);
    ...
    describe('without template', () => {
        it('should work without templateId', async () => {
            const configNoTemplate = {
                ...mockConfig,
                templateId: undefined,
            };
            const agentNoTemplate = new GenericAnalysisAgent(configNoTemplate, mockRouter, mockTemplateLoader, mockDiagramGenerator);
...
//# sourceMappingURL=generic-analysis.agent.test.js.map