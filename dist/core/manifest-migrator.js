...
import { AGENT_TO_SUBDIR_MAP, AGENT_TO_FILENAME_MAP } from '../types.js';
/**
 ...
 */
function buildFileLocations(manifest) {
    const locations = {};
 ...
 */
function calculateStructureHash(locations) {
 ...
 */
export function getVersionBump(oldLocations, newLocations) {
