...
export async function applyCommand(
    ...
    // Create logger
    const logger = {
        info: (msg: string) => console.log(`[Apply] ${msg}`),
        error: (msg: string) => console.error(`[Apply] ${msg}`),
        warn: (msg: string) => console.warn(`[Apply] ${msg}`),
    };
 ...
 */
export function parseApplyArgs(args: string[]): { repoPath: string; options: ApplyCommandOptions } {
 ...
 */
export function printApplyHelp(): void {
    console.log(`
